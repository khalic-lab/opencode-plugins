...
**Date:** 2026-07-31 · **Status:** resolved 2026-08-09 — built the plugin (see `README.md`, `plugin/`); decision followed findings/fable.md: own minimal plugin, local mlx classifier, shadow-first rollout · **Owner:** khalic-lab
